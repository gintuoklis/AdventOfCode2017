defmodule RegistersTest do
  ...
  test "process small file" do
    assert Registers.processfile("b inc 5 if a > 1
a inc 1 if b < 5
c dec -10 if a >= 1
c inc -20 if c == 10") == 1
  end

  test "process big file" do
    assert Registers.processfile("t inc 245 if xq != 0
hi inc 119 if gf >= -5
w dec 529 if s == 0
p inc 19 if fi > -2
