...
gyxo (61)
cntj (57)") ==
  %{"cntj" => %{parent: "fwft", weight: 0},
    "ebii" => %{parent: "ugml", weight: 0},
    "fwft" => %{parent: "tknk", weight: 0},
    "gyxo" => %{parent: "ugml", weight: 0},
    "havc" => %{parent: "padx", weight: 0},
    "jptl" => %{parent: "ugml", weight: 0},
    "ktlj" => %{parent: "fwft", weight: 0},
    "padx" => %{parent: "tknk", weight: 0},
    "pbga" => %{parent: "padx", weight: 0},
    "qoyq" => %{parent: "padx", weight: 0},
    "ugml" => %{parent: "tknk", weight: 0},
    "xhth" => %{parent: "fwft", weight: 0}}
end

  test "test 2" do
    assert Tree.processline("pbga (66)") == %{}
  end
  test "test 3" do
    assert Tree.processline("fwft (72) -> ktlj, cntj, xhth") ==
      %{"cntj" => %{parent: "fwft", weight: 0},"ktlj" => %{parent: "fwft", weight: 0},"xhth" => %{parent: "fwft", weight: 0}}
  end

  test "test 4" do
    assert Tree.findtopnode("pbga (66)
  xhth (57)
  ebii (61)
  havc (66)
  ktlj (57)
  ...
  test "test 5" do
    assert Tree.findtopnode("rmhcw (26)
dmmriu (61)
