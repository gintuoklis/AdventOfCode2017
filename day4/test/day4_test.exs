defmodule PassphrasesTest do
  ...
  test "phrase 1" do
    assert Passphrases.validate("aa bb cc dd ee") == :valid
  end

  test "phrase 2" do
    assert Passphrases.validate("aa bb cc dd aa") == :invalid
  end

  test "phrase 3" do
    assert Passphrases.validate("aa bb cc dd aaa") == :valid
  end

  test "phrase 4" do
    assert Passphrases.validate2("aa bb cc dd aaa") == :valid
  end

  test "file 1" do
    assert Passphrases.count_valid_phrases("kvvfl kvvfl olud wjqsqa olud frc
...
rvbu czwpdit vmlihg spz lfaxxev zslfuto oog dvoksub")==337
  end

  test "file 2" do
    assert Passphrases.count_valid_phrases2("kvvfl kvvfl olud wjqsqa olud frc
slhm rdfm yxb rsobyt rdfm
pib wzfr xyoakcu zoapeze rtdxt rikc jyeps wdyo hawr xyoakcu hawr
ismtq qwoi kzt ktgzoc gnxblp dzfayil ftfx asscba ionxi dzfayil qwoi
dzuhys kfekxe nvdhdtj hzusdy xzhehgc dhtvdnj oxwlvef
...
mhvisju lhmdbs tcxied xeidtc ujry cditex gvqpqm
cgc jazrp crgnna uvuokl uvuokl uoiwl sknmc sknmc
rvbu czwpdit vmlihg spz lfaxxev zslfuto oog dvoksub")==231
  end
end
